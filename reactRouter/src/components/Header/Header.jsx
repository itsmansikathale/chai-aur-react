...
return (
    <header className='shadow sticky z-50 top-0'>
        <nav className='bg-white border-gray-600 px-4 
        lg:px-6 py-2.5'>
            <div className='flex flex-wrap justify-between 
            items-center mx-auto max-w-screen-xl'>
                <Link to="/" className="flex items-center">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUkoOacsPWf52bUGhAky8-sOr1K5g6mRZCtw&usqp=CAU" alt="Logo" 
                    className='mr-3 h-12'
                    />
                </Link>
                <div className='flex items-center lg:order-2'>
                    ...
                    focus:ring-4 focus:ring-offset-gray-400 font-medium
                    ...
                    <Link 
                    to="#"
                    className="text-white bg-orange-600 hover:bg-orange-800
